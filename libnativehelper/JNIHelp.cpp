...
#ifdef NATIVE_HELPER_HAVE_AEE_FEATURE
#include "aee.h"

const char* art_wiki = "Please refer to http://wiki/display/ART/Issue+Lesson+Learning for more information";
#define NATIVE_HELPER_AEE_EXCEPTION(_msg, _className, _extraMsg)                                    \
    do {                                                                                            \
...
#else
#define NATIVE_HELPER_AEE_EXCEPTION(...)
#endif  // NATIVE_HELPER_HAVE_AEE_FEATURE
    ...
    const JNINativeMethod* gMethods, int numMethods)
{
    ...
    if (c.get() == NULL) {
        ...
        NATIVE_HELPER_AEE_EXCEPTION(msg, className, art_wiki);
        e->FatalError(msg);
    }
