...
// ArrayIndexInfo is represented as a pair of array index and corresponding array length
typedef std::pair<HInstruction*, HArrayLength*> ArrayIndexInfo;
typedef std::vector<ArrayIndexInfo> ArrayIndexList;
// Forward declaration
class ValueRange;
// ArrayRangeInfo is represented as a pair of array index and corresponding value range
typedef std::pair<HInstruction*, ValueRange*> ArrayRangeInfo;
typedef std::vector<ArrayRangeInfo> ArrayRangeList;
