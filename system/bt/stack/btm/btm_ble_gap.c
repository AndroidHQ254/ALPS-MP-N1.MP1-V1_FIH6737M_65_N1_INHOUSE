...
static void btm_ble_vendor_capability_vsc_cmpl_cback (tBTM_VSC_CMPL *p_vcs_cplt_params)
{
    ...
    if (status == HCI_SUCCESS)
    {
        ...
        /*For bug fixed, to read new parameters defined in android M. btm_cb.cmn_ble_vsc_cb.version_supported is 96 from HCI, 
          but BTM_VSC_CHIP_CAPABILITY_M_VERSION is defined as 95*/
        /*original: if (btm_cb.cmn_ble_vsc_cb.version_supported == BTM_VSC_CHIP_CAPABILITY_M_VERSION)*/  
