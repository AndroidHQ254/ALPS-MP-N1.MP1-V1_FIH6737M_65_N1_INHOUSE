...
#if (MTK_COMMON == TRUE)
#define BTA_AG_MULTI_CALL_RES       20  /* SLC at three way call */
#define BTA_AG_BIND_RES             21  /* Activate/Deactivate HF indicator */
#define BTA_AG_UNAT_RES             22  /* Response to unknown AT command event */
#else
