...
include device/mediatek/banyan_addon/TOOLSET_VERSION
...
$(banyan_full_target): copy_docs
	...
	$(hide) mkdir -p $(dir $@)
ifneq ($(filter all api sdk toolset bsp,$(BUILD_MTK_SDK)),)
  ifneq ($(filter all sdk api,$(BUILD_MTK_SDK)),)
