...
mtk-setup-jack-server:
	...
	python device/mediatek/build/build/tools/jack_find_port.py find_port $(MTK_JACK_ENV) 127.0.0.1 50000 60000 2
ifneq ($(dist_goal),)
	...
	$(PRIVATE_JACK_ADMIN) install-server $(PRIVATE_PATH)/jack-launcher.jar $(PRIVATE_SERVER_JAR)  2>&1 || (exit 0)
	python device/mediatek/build/build/tools/jack_find_port.py update_client $(MTK_JACK_ENV) 127.0.0.1 50000 60000 2
ifneq ($(dist_goal),)
